    ...
    <form method="POST">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input name="header_text" type="text" id="header_text" value="<?php echo get_option('header_text') ?>" class="regular-text">
                </td>
            </tr>

            <tr>
                <th scope="row"><label for="devices_sec_p">Devices Section Paragraph</label></th>
                <td><input name="devices_sec_p" type="text" id="devices_sec_p" value="<?php echo get_option('devices_sec_p') ?>" class="regular-text"></td>
            </tr>
        ...
        <table class="form-table">
                ...
                <td><input name="steps_title" type="text" id="steps_title" value="<?php echo get_option('steps_title') ?>" class="regular-text"></td>
            </tr>

            <tr>
                <th scope="row"><label for="step_1">Step 1</label></th>
                <td><input name="step_1" type="text" id="step_1" value="<?php echo get_option('step_1') ?>" class="regular-text"></td>
            </tr>

            <tr>
                <th scope="row"><label for="step_1_desc">Step 1 Description</label></th>
                <td><textarea name="step_1_desc"  id="step_1_desc" class="regular-text"><?php echo get_option('step_1_desc') ?></textarea></td>
            </tr>

            <tr>
                <th scope="row"><label for="step_2">Step 2</label></th>
                <td><input name="step_2" type="text" id="step_2" value="<?php echo get_option('step_2') ?>" class="regular-text"></td>
            </tr>

            <tr>
                <th scope="row"><label for="step_2_desc">Step 2 Description</label></th>
                <td><textarea name="step_2_desc"  id="step_2_desc" class="regular-text"><?php echo get_option('step_2_desc') ?></textarea></td>
            </tr>

            <tr>
                <th scope="row"><label for="step_3">Step 3</label></th>
                <td><input name="step_3" type="text" id="step_3" value="<?php echo get_option('step_3') ?>" class="regular-text"></td>
            </tr>

            <tr>
                <th scope="row"><label for="step_3_desc">Step 3 Description</label></th>
                <td><textarea name="step_3_desc"  id="step_3_desc" class="regular-text"><?php echo get_option('step_3_desc') ?></textarea></td>
            </tr>
        ...
        <table class="form-table">
            <tr>
                ...
                <td><input name="email" type="text" id="email" value="<?php echo get_option('email') ?>" class="regular-text"></td>
            </tr>
        ...
        <table class="form-table">
            <tr>
                ...
                <td><input name="copyright" type="text" id="copyright" value="<?php echo get_option('copyright') ?>" class="regular-text"></td>
            </tr>
        </table>
